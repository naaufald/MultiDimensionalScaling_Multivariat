...
scatter = ax.scatter(X_reduced[:, 0], X_reduced[:, 1], c=y, cmap=plt.cm.get_cmap("jet", 10))
cbar = fig.colorbar(scatter, label='Digit Label', ticks=range(10))
ax.set_title("MDS Visualization of Digits Dataset")
...
mds = MDS(n_components=2, random_state=42)
X_2d = mds.fit_transform(X)
('Dimension of X after MDS : ', X_2d.shape)
